...
export default async function BlogPage({ params }: { params: { slug: string } }) {
  ...
  const jsonLd = {
    ...
    "datePublished": slug === "mobile-first-typography-guide" ? "2026-07-19T08:00:00+00:00" : (slug === "variable-fonts-guide" ? "2026-07-18T08:00:00+00:00" : (slug === "accessibility-first-typography-guide" ? "2026-07-17T08:00:00+00:00" : "2025-05-15T08:00:00+00:00")),
