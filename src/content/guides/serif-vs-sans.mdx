...
*   Brands wanting to convey luxury, heritage, or seriousness (law firms, high-end fashion, traditional finance). If you are building an online store in this niche, you can read our [E-Commerce Typography Guide](/blog/ecommerce-typography-guide) for specific applications.
...
Whether you choose a serif or a sans-serif, legibility should always be your top priority. Make sure your font choices meet WCAG standards by reading our deep dive into [accessibility-first typography](/blog/accessibility-first-typography-guide).
